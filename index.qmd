...
![Finished Bar](images/finished-bar.jpg){#fig-finished-bar fig-alt="Finished Bar" fig-align="center"}
...
![Bare kite bars](images/bare-bars.jpg){#fig-bare-bars fig-alt="Bare kite bars" fig-align="center"}
...
![Kite-side of the bar showing the smooth, round bore holes](images/kite-side-borehole.jpg){#fig-kite-side-borehole fig-alt="Kite-side of the bar showing the smooth, round bore holes"}
...
![Pilot-side of a bare bar Pilot-side of a bare bar showing the left and right cuts around the bore the left and right cuts around the bore](images/pilot-side-borehole.jpg){#fig-pilot-side-borehole fig-alt="Pilot-side of a bare bar showing the left and right cuts around the bore" fig-align="center"}
...
![Threading end of the trim line formed with a wrap of insignia cloth](images/thread-end-of-trimline.jpg){#fig-thread-end-of-trimline fig-alt="Threading end of the trim line formed with a wrap of insignia cloth" fig-align="center"}

### Loose end of the trim line

The loose end of the trimline is designed to be easily gripped for trim control and easily tethered when not being handled. The tethering is done via a pair of magnets attached to the trimline with a wrap of insignia cloth. The insignia cloth is reinforced with a shaped piece of plastic cord. A pair of stopper balls provide a stop at the cleat and a handle just above the magnets. The a completed end is visible in @fig-finished-end-of-trimline

![Grip end of the trim line with balls offset to show knots (above) and thread end (below)](images/finished-end-of-trimline.jpg){#fig-finished-end-of-trimline fig-alt="Grip end of the trim line with balls offset to show knots (above) and thread end (below)" fig-align="center"}
...
![Insignia cloth patch to hold trimline magnets](images/magnetic-trimline-tails-9.jpg){#fig-magnetic-trimline-tails-9 fig-alt="Insignia cloth patch to hold trimline magnets" fig-align="center"}
...
The mandrel can be made from 5/8" diameter CPVC piping, a few strip cut from a plastic bucket to form a spacer and two screws to hold the parts together. The assembled mandrel is shown in @fig-plastic-cord-mandrel and @fig-plastic-cord-mandrel-end-view

![Mandrel for forming the plastic cord that surrounds the magnets](images/plastic-cord-mandrel.jpg){#fig-plastic-cord-mandrel fig-alt="Mandrel for forming the plastic cord that surrounds the magnets" fig-align="center"}

![End view of the mandrel](images/plastic-cord-mandrel-end-view.jpg){#fig-plastic-cord-mandrel-end-view fig-alt="End view of the mandrel" fig-align="center"}
...
Thread a medium stopper ball onto the trimline, recessed side first. Slide it all the way to the knot next to the magnet wrap. If the ball does not jam tight on the knot, retie the knot as a figure-eight to make it fatter and improve the fit against the inside of the ball. Mark the trimline 65mm above the top of the medium ball. Tie an overhand knot in the trimline just above that mark. Now thread a small ball onto the trim line and slide it all the way to the knot. Again, if the ball is not tight on the knot, retie it as a figure-eight knot to adjust the fit. The finished product can be seen in @fig-finished-end-of-trimline
...
![Template for making an Aero Cleat Jacket](images/cleat-jacket-template.png){#fig-cleat-jacket-template.png fig-alt="Template for making an Aero Cleat Jacket" fig-align="center"}

## Separation block

The juncture of the flying lines and the trim line is managed by the *separation block* as shown in @fig-separation-block

![Separation block](images/separation-block.jpg){#fig-separation-block fig-alt="Separation block" fig-align="center"}
...
![Bar end loop](images/bar-end-loop.jpg){#fig-bar-end-loop fig-alt="Bar end loop" fig-align="center"}

## Steering Lines

The steering lines run from the bar end loops to the ends of the back lines. They require two 1165mm segments of 1/16" Ultrex 12. Mark one end of each segment at 110, 190, 270, and 410mm. Use these marks to create a brummel splice with an 80mm loop. See the loop details in @fig-steering-line-loop-details

![Steering line loop details](images/steering-line-loop-details.png){#fig-steering-line-loop-details fig-alt="Steering line loop details" fig-align="center"}
...
![Assembled mini-chickenloop](images/assembled-mini-chickenloop.jpg){#fig-assembled-mini-chickenloop-a fig-alt="Assembled mini-chickenloop" fig-align="center"}

The MCL is constructed from 410mm of 2.5mm (7/64") Amsteel Blue, 140mm of 2mm bungie, a release pin made from 80mm of 0.102" diameter stainless steel, a 24mm pin of 0.102" diameter stainless steel, and a 3-D printed chickenloop release. The 3-D model for the [chickenloop release](https://github.com/pbchase/kite_bar_parts/blob/master/printable/chickenloop_release_d1928a2.stl) is accessible in the [Kite Bar Barts](https://github.com/pbchase/kite_bar_parts) repository. Examples of the printed part are shown in @fig-chickenloop-release

![Mini-chickenloops as printed](images/chickenloop-release.jpg){#fig-chickenloop-release fig-alt="Mini-chickenloops as printed" fig-align="center"}
...
![Mini-chickenloop with the trimline retention pin installed](images/chickenloop-release-with-pin.jpg){#fig-chickenloop-release-with-pin fig-alt="Mini-chickenloop with the trimline retention pin installed" fig-align="center"}
...
![Form large parallel loops of line on each side of the cleat's serpentine path. Route about 5cm of the trim out of the top of the cleat.](images/threading-the-cleat-1.jpg){#fig-threading-the-cleat-1 fig-alt="Form large parallel loops of line on each side of the cleat's serpentine path. Route about 5cm of the trim out of the top of the cleat." fig-align="center"}

![Route the 5cm of trim line tail through the loops along the side of the serpentine.](images/threading-the-cleat-2.jpg){#fig-threading-the-cleat-2 fig-alt="Route the 5cm of trim line tail through the loops along the side of the serpentine." fig-align="center"}

![Route the insignia cloth tail through the loops. Holding the tail in place, pull the trim line slack down through the cleat grooming the lines as you go. Keep the lines as parallel as possible. Take the slack out of the trimline loops 1 of 3.](images/threading-the-cleat-3.jpg){#fig-threading-the-cleat-3 fig-alt="Route the insignia cloth tail through the loops. Holding the tail in place, pull the trim line slack down through the cleat grooming the lines as you go. Keep the lines as parallel as possible. Take the slack out of the trimline loops 1 of 3." fig-align="center"}

![Take the slack out of the trimline loops 2 of 3.](images/threading-the-cleat-4.jpg){#fig-threading-the-cleat-4 fig-alt="Take the slack out of the trimline loops 2 of 3." fig-align="center"}

![Take the slack out of the trimline loops 3 of 3.](images/threading-the-cleat-5.jpg){#fig-threading-the-cleat-5 fig-alt="Take the slack out of the trimline loops 3 of 3." fig-align="center"}
...
Route the left-side flying line through the remaining hole in the separation block. Continue routing it through the cleat bead and then the bar. Attach the flag line to the flying line with a larks head. Pull flag line up through the bar and bead with the flying line. The routed lines should look like @fig-flag-line-at-separation-block at the separation block. The over-all assembly should look like @fig-upper-section-of-assembled-bar

![The flag line meets the flying line.](images/flag-line-at-separation-block.jpg){#fig-flag-line-at-separation-block fig-alt="The flag line meets the flying line." fig-align="center"}

![Assembled bar](images/upper-section-of-assembled-bar.jpg){#fig-upper-section-of-assembled-bar fig-alt="Assembled bar" fig-align="center"}
