...
The pilot-side of the bore hole needs to be deeply beveled left and right of the trimline borehole as shown in Figure \@ref(fig:pilot-side-borehole).  This allows the bar to be sheeted in and out during hard turns. Without the cutouts, the bar could bind in a turn and sheeting changes would be difficult to impossible.

```{r pilot-side-borehole, fig.cap="Pilot-side of the bar.", echo = FALSE, out.width='70%', fig.align='center'}
