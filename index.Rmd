...
* 1 [Separation Block release 1.4.2](https://github.com/pbchase/kite_bar_parts/blob/1.4.2/printable/separation_block_v1_9a972b6.stl)
...
To build the trimline, you will need ~2500mm of Amsteel Blue (use only the gray color), ~80mm x 105m of insignia cloth (dark colors are better), two 18mm x 3mm nickel-plated neodymium disc magnets, one Small Stopper Ball Blue 5/32" ID	(R1905 at APS Limited), and one Medium Stopper Ball Green 1/4" ID (R1994 at APS Limited). 

Cut a segment of gray 4mm Amsteel Blue to a length of 2430mm with a fresh razor blade to get a clean cut.

Cut a strip of sailmaker's insignia cloth according to the dimensions shown in \@ref(fig.magnet-wrap) below to wrap the magnets.

```{r magnet-wrap, fig.cap="Insignia cloth patch to hold trimline magnets", echo = FALSE}
...
Thread a 25mm ball onto the trimline, resessed side first. Slide it all the way to the knot next to the magnet wrap. Mark the trimline 65mm above the top of the green ball. Tie and overhand knot in the trimline just above that knot. Now thread a 12mm ball onto the trim line and slide it all the way to the knot. 

![finished end of trimline](images/finished_end_of_trimline.jpg)

## Cleat Jacket

The Aero Cleat requires a jacket of magnetic stainless steel sheet to create a tether point for the trimline tail. Make a template from the image below, trace the pattern onto a sheet of 0.025" thick 430 stainless steel sheet. You can also make your own template by placing the metal portion of the cleat into a piece of cardboard and tracing its outline on 3 sides or jus trace it directly onto the metal. Cut the shap from the metal sheet, drill out the two holes with a 5/32" bit and ease all the edges with a metal file. Most of these edges will be on grippable surfaces, so do a good job of easing them.

Disassemble the cleat and reassemble it with metal sheet between the two sections of the cleat. Bend the metal around the metal portion of the Aero cleat. To do this, clamp one side of the jacket in a vise. USe a block of wood and mallet to fold the other side against metal side of the cleat. Flip the cleat over to expose the other side of the jacket and clamp the cleat in the vise. Again use the block of wood and a mallet to fold the remaining wing. Remove the cleat from the vise, lay it flat on a table top and use the block and mallet to crease the folds. 

![cleat jacket template](images/magnetic_trimline_tails_12.jpg)
...
Pick out 4 strands from one end of Amsteel pulling out one strand at each of 5, 10, 15, and 20mm to form a tapered end. Cut each strand off with a razor blade. Wrap that end of theAmsteel with a rectangle of insignia cloth. Wrap the 20mm dimension around the line with 30mm on the line and 35mm off. 

![unfinished separation block cord](images/unfinished_separation_block_cord.jpg)

Measure 95mm from the tip of the tapered line. Pierce the line at 95mm and start a brummel splice at the mark. Place the low-friction ring inside the loop. Pull the loop tight around the ring. Run a wire fid from a point 20mm from the opposite end of the line. Pop the fid out of the line at the ring. USe the wire fid to pull the tapered end inside. When you pull the end of the tapered end out, peel off the extra insignia cloth before you bury it. Use the second piece of insignia cloth to put a threading end on the finished piece. 

![finished separation block cord](images/finished_separation_block_cord.jpg)


![finished separation block cord picture](images/finished_separation_block_cord_pic.jpg)

Thread the resulting line-ring assembly through the center bore of the separation block. Tie an overhand knot in the Amsteel taking out as much slack as possible.

![finished separation block assembly](images/finished_separation_block_assembly.jpg)
...
Mark the 300mm line segment 130mm from one end. Use a wire fid to splice the 130mm segment inside the 170mm segment that remains. The resulting segment will be about 155mm long.  The segment is mostly double thickness with about 300mm of single thickeness line on the end. Apply cyanoacrylate glue to the unfinished end. Fold the 155mm segment in half and tie an overhand knot to form a small loop.

![Stub Line](images/07_stub_line_for_termination_of_non-flagging_topline_2019-03-23_1.jpg)
...
![Bar End Loops](images/05_kite_bar_rigging_2015-10-06_3.jpg)
...
![Steering Lines 1/2](images/03_components_for_IBX_bar_2019-03-16_2.jpg)
![Steering Lines 2/2](images/04_kite_bar_rigging_2015-10-06_2.png)
...
You'll want to verify you can reach the trimline end under normal flying conditions. It's easier to assess the cleat position  before the flying lines are attached so paude the assembly for a moment to check and adjust the cleat position.  To do this, put your harness on, clip the trim line into the harness and have a friend pull on the trim line by the separation block. They should pull the bar to your side about 30 degrees above horizontal. Verify you can reach the jaws of the cleat and grab the trim line tail without over-reaching. If you have to stretch to reach the tail, the cleat is too far away. You can move it closer by moving some of the trim line up through the cleat. For each centimeter you need to move the cleat down, you'll need to move two centimeters of line through the cleat. Making this adjustment is a bit tedious, but the trim line tail must be in easy reach under load.
...
Route the other flying line through the remaining hole in the separation block. Continue routing it through the cleat bead and then the bar. Attach the flag line to the flying line with a larks head. Pull flag line up through the bar and bead with the flying line.
